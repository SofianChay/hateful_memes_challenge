...
def parse_args():
    ...
    parser.add_argument('--image_dir', default='../data/img',
...
if __name__ == '__main__':
    ...
    for im_file in tqdm(imglist):
        ...
        pooled_feat = pooled_feat.data.cpu()
        ...
        features[id_] = image_feat

    if not os.path.exists('../bottom_up'):
        os.makedirs('../bottom_up')
    pickle.dump(features, open('../bottom_up/images_features_dict.pkl', 'wb'))
