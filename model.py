...
class MyVisualBert(nn.Module):
    ...
    def __init__(self):
        ...
        self.visual_bert = model_cls.from_pretrained("visual_bert.finetuned.hateful_memes.from_coco").model
        ...
        self.classifier = nn.Sequential(nn.Linear(768, 768), nn.ReLU(), nn.Dropout(.1), nn.LayerNorm(768), nn.Linear(768, 2))
    ...
    def forward(self, input_ids, attention_mask, visual_embeddings):
        ...
        _, pooled, _ = self.visual_bert.bert(input_ids=input_ids, 
